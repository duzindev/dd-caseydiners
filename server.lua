...
RegisterNetEvent('dd-caseysdiner:server:dutyToggle', function()
    local src = source
...
RegisterNetEvent("dd-caseysdiner:server:finishCraft", function(recipe)
    local src = source
    if not recipe or not recipe.item or not recipe.ingredients then return end
